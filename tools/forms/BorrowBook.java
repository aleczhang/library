...
/*
 * Created by JFormDesigner on Sat Jan 15 21:53:31 CST 2011
 */
...
public class BorrowBook extends JDialog {
	public BorrowBook(Frame owner) {
		super(owner);
		initComponents();
	}

	public BorrowBook(Dialog owner) {
		super(owner);
		initComponents();
	}
	...
	private void initComponents() {
		...
		//======== dialogPane ========
		{
			...
			//======== contentPanel ========
			{
				...
				//---- label1 ----
				label1.setText("\u8bfb\u8005\u6761\u5f62\u7801\uff1a");
				contentPanel.add(label1, cc.xy(1, 1));
				contentPanel.add(textField1, cc.xy(3, 1));

				//---- label3 ----
				label3.setText("\u4e66\u7c4d\u6761\u7801\u53f7\uff1a");
				contentPanel.add(label3, cc.xy(5, 1));
				contentPanel.add(textField3, cc.xy(7, 1));

				//---- label4 ----
				label4.setText("\u8bfb\u8005\u59d3\u540d\uff1a");
				contentPanel.add(label4, cc.xy(1, 3));

				//---- textField4 ----
				textField4.setEditable(false);
				contentPanel.add(textField4, cc.xy(3, 3));

				//---- label2 ----
				label2.setText("\u8bfb\u8005\u7c7b\u578b\uff1a");
				contentPanel.add(label2, cc.xy(5, 3));

				//---- textField2 ----
				textField2.setEditable(false);
				contentPanel.add(textField2, cc.xy(7, 3));
